...
class AddedElinWidget extends StatefulWidget {
  final String token;
  const AddedElinWidget({Key? key, required this.token}) : super(key: key);
  @override
  State<AddedElinWidget> createState() => _AddedElinWidgetState();
}

class _AddedElinWidgetState extends State<AddedElinWidget>
  ...
  Future<List<PageModel>> getAddedData() async {
    final response = await http.get(Uri.parse(
        '$baseUrl/elin-added-list/?author=${widget.token}&page=$page'));

                        ...
                        onPressed: () {
                          (SeyirApp.tokenNotifier.value == false)
                              ...
                              : Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const CreateLog()));
                        },
          ...
          futureDatas.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    int lastday =
                        int.parse(futureDatas[index].lastDate.substring(8, 10));
                    int lastmonth =
                        int.parse(futureDatas[index].lastDate.substring(5, 7));
                    int lastyear =
                        int.parse(futureDatas[index].lastDate.substring(0, 4));

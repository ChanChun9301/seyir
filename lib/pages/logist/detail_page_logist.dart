        ...
        body: SingleChildScrollView(
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  int lastday =
                      int.parse(snapshot.data!.lastDate.substring(8, 10));
                  int lastmonth =
                      int.parse(snapshot.data!.lastDate.substring(5, 7));
                  int lastyear =
                      int.parse(snapshot.data!.lastDate.substring(0, 4));
                  images.clear();
                                        ...
                                        children: [
                                          Text(
                                            (snapshot.data!.isBring == true)
                                                ...
                                                : 'Alyp gitmeli',
                                            style: TextStyle(
                                              color: (snapshot.data!.isBring ==
                                                      true)
                                                  ? (SeyirApp.themeNotifier
                                                              .value ==
                                                          ThemeMode.light
